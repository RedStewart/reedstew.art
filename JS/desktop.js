...
export const deskSkillsBuild = mainDiv => {
    let iconArr = [];

    let skillWordDiv = document.createElement("div");
    ...
    let skillsTextTitle = document.createElement("h3");
    skillsTextTitle.id = "skillsTextTitle";

    let skillsTextDescrip = document.createElement("p");
    ...
    let skillIconDiv = document.createElement("div");
...
const deskDrawSVG = (idName, className, path) => {
    let svgJS = document.createElementNS("http://www.w3.org/2000/svg", "svg");
    svgJS.setAttribute("class", className);
    svgJS.setAttribute("id", idName);
    svgJS.setAttribute("viewBox", "0 0 128 128");

    let svgJSPath = document.createElementNS(
